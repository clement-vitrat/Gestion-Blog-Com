    ...
    <body>
        ...
        <nav>
            ...
            <ul>
                ...
                <li><a href="login_form.php" class="active">Se connecter</a></li>
            </ul>
        </nav>
        ...
        <div class="login">
            ...
            <form action="login.php" method="post">
                <p><input id="input" type="email" class="mail" name="email" placeholder="ADRESSE MAIL" required></p>
                <p><input id="input" type="password" class="mdp" name="password" placeholder="MOT DE PASSE" required></p>
